...
public class NimState extends GameStateImpl {
	 ...
	 * 
	 * @param move
	 *            A list of integers representing the move in the following
	 *            form: [int1, int2, ..., intn].
	 */
	 ...
	 * 
	 * @param stringMove
	 *            string representing the move in the following form: [int1,
	 *            int2, ..., intn].
	 */
	 ...
	 * 
	 * @param move @see {@link sac.examples.nim.NimState#makeMove(List)}
